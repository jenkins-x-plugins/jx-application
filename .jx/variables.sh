...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/jx-application/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-application:0.0.36'
