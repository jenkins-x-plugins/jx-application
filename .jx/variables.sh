...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-application/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-application:0.3.9'
